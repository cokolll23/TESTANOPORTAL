...
<?/*if(IsModuleInstalled("idea")):?>
    <?$APPLICATION->IncludeComponent("bitrix:idea.popup", "", array(
            ...
            "PATH_IDEA_INDEX" => "/bonus-shop/about/idea/",
            "PATH_IDEA_POST" => "/bonus-shop/about/idea/#post_id#/",
            "BUTTON_COLOR" => "",
            "POST_BIND_STATUS_DEFAULT" => "#IDEA_BIND_STATUS_DEFAULT#",
            "FORGOT_PASSWORD_URL" => "/bonus-shop/login/?forgot_password=yes",
            "REGISTER_URL" => "/bonus-shop/login/?clear_cache=Y",
            "CATOGORIES_CNT" => "4",
