    ...
    <div class="interlabs-feedbackform__container__dialog">
        ...
        <div class="body">
            ...
            <form method="post" enctype="multipart/form-data" action=""
                ...
                <?php if ($arResult['AGREE_PROCESSING'] === 'Y') { ?>
                    <div class="form-group agree">
                        <div class="c-checkbox">
                            ...
                            <label for="AGREE_PROCESSING"><?php echo Loc::getMessage("AGREE_PROCESSING"); ?><span
                ...
                <div class="form-group">
                    <button class="modal-default-button js-interlabs-feedbackform__dialog__send-button4"
                            type="submit">
