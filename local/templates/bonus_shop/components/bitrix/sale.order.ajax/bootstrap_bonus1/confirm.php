				...
				if ($payment["PAID"] != 'Y')
				{
					...
					)
					{
						...
						if (empty($arPaySystem["ERROR"]))
						{
							...
							<!--<div class="row mb-2">
								<div class="col">
									<h3 class="pay_name"><?php /*=Loc::getMessage("SOA_PAY") */?></h3>
								</div>
							</div>
							<div class="row mb-2 align-items-center">
								<div class="col-auto"><strong><?php /*=$arPaySystem["NAME"] */?></strong></div>
								<div class="col"><?php /*=CFile::ShowImage($arPaySystem["LOGOTIP"], 100, 100, "border=0\" style=\"width:100px\"", "", false) */?></div>
							</div>
							<div class="row mb-2">
								<div class="col">
									...
									*/?>
									<script>
										window.open('<?php /*=$arParams["PATH_TO_PAYMENT"]*/?>?ORDER_ID=<?php /*=$orderAccountNumber*/?>&PAYMENT_ID=<?php /*=$paymentAccountNumber*/?>');
									</script>
									<?php /*=Loc::getMessage("SOA_PAY_LINK", array("#LINK#" => $arParams["PATH_TO_PAYMENT"]."?ORDER_ID=".$orderAccountNumber."&PAYMENT_ID=".$paymentAccountNumber))*/?>
									<?/* if (CSalePdf::isPdfAvailable() && $arPaySystem['IS_AFFORD_PDF']): */?>
									<br/>
										<?php /*=Loc::getMessage("SOA_PAY_PDF", array("#LINK#" => $arParams["PATH_TO_PAYMENT"]."?ORDER_ID=".$orderAccountNumber."&pdf=1&DOWNLOAD=Y"))*/?>
									<?/* endif */?>
									<?/* else: */?>
										<?php /*=$arPaySystem["BUFFERED_OUTPUT"]*/?>
									<?/* endif */?>
								</div>
							</div>-->
